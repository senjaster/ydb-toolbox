...
create_aliases() {
    ...
    local original_ps1="$3"
    
    cat > "$aliases_file" << EOF
# YDB Tools Aliases
# Auto-generated by ydb-shell.sh

# Set custom prompt - prepend YDB indicator to original PS1
export PS1='\[\033[1;36m\][YDB:\[\033[1;32m\]\$YDB_DATABASE\[\033[1;36m\]]\[\033[0m\] $original_ps1'
...
main() {
    ...
    # Capture original PS1 from current shell, or use default
    local original_ps1="${PS1:-\\u@\\h:\\w\\$ }"
